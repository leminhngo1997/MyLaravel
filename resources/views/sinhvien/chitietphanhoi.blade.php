    ...
    <div class="card border-secondary shadow py-2 col-12">
        ...
        <div class="card-body">
            <div class="mb-4">
                        ...
                        <strong>John Doe</strong> - <strong>HTTT2020</strong>
                        <!-- nội dung thắc mắc -->
                        <p class="text-smaller text-muted mb-0">Just now</p>
            </div>
            <div class="border mb-3">
                <div class="m-1 h3">thắc mắc abc xyz thắc mắc abc xyz thắc mắc abc xyz thắc mắc 
                    abc xyz thắc mắc abc xyz thắc mắc abc xyz
                    abc xyz thắc mắc abc xyz thắc mắc abc xyz
                    abc xyz thắc mắc abc xyz thắc mắc abc xyz</div>
            </div>
            <button type="button" class="btn btn-outline-secondary">Bình luận</button>
        </div>
    </div>
    <div class="row">
        <div class="col-1"></div>
            ...
            <ul class="mb-4">
                <li class="border-bottom border-top">
                    <div class="d-flex justify-content-between">
                        <div class="text-small">
                            ...
                            <p class="last-message text-muted">không biết không biết không biết không biết không biết không biết</p>
                        </div>
                ...
                <li class="border-bottom border-top">
                    <div class="d-flex justify-content-between">
                        <div class="text-small">
                            <strong>Alex Steward</strong> - <strong>HTTT2019</strong>
                            <p class="last-message text-muted">không biết không biết không biết không biết không biết không biết không biết không biết không biết không biết không biết không biết không biết</p>
                        </div>
                        <div class="chat-footer">
                            <p class="text-smaller text-muted mb-0">Yesterday</p>
                            <span class="text-muted float-right"><i class="fas fa-mail-reply" aria-hidden="true"></i></span>
